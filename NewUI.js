...
function updateValueFields() {
    ...
    else if (shouldFarm && !doVoids) status.innerHTML = 'Farming: ' + (100 * Math.pow(2, 0.05 * (10 - farmingRatio).toFixed(3) + '%';
    else if (stackingTox) status.innerHTML = 'Getting Tox Stacks';
    else if (!enoughDamage) status.innerHTML = 'Want more damage: ' + (enoughDamageRatio * 100).toFixed(3) + '%';
